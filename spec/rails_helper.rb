...
RSpec.configure do |config|
  ...
  # If you're not using ActiveRecord, or you'd prefer not to run your suite of
  # tests within a transaction, remove the following line or assign false
  # instead of true.
  ...
  # FactoryBot is automatically configured by the gem
